...
import { ClueParams, CompleteClueRequest, VerifyCluePasswordRequest } from '../types/api';

class ClueController {
  static async getClue(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  static async getUserClues(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  static async unlockClue(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id: clueId }: ClueParams = req.params as ClueParams;
